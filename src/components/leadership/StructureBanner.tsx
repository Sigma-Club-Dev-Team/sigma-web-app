...
function StructureBanner() {
  return (
    <section className="md:py-25 md:px-60 bg-sigma-navy flex md:flex-col items-center justify-center relative text-white overflow-hidden">
      ...
      <div className="flex flex-col items-center md:items-star justify-center md:gap-2 md:py-6">
        <h1
          className={`${goudyOldStyle.className} text-center md:text-center  text-sm md:text-[4rem] leading-[4.4rem] uppercase `}
        >
      ...
      <p className="w-160 text-[1.125rem] tracking-[-0.01125rem] text-center">
